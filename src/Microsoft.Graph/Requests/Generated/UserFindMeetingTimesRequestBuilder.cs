...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class UserFindMeetingTimesRequestBuilder : BasePostMethodRequestBuilder<IUserFindMeetingTimesRequest>, IUserFindMeetingTimesRequestBuilder
    {
        /// <summary>
        ...
        protected override IUserFindMeetingTimesRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            ...
            {
                request.RequestBody.MeetingDuration = this.GetParameter<TimeSpan?>("meetingDuration");
            }
